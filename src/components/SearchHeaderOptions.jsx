...
import { usePathname,useRouter,useSearchParams,userSearchParams } from "next/navigation";
...
export default function SearchHeaderOptions() {
  ...
  return (
    <div className="flex space-x-2 select-none border-b w-full justify-center md:justify-start lg: pl-52 text-gray-700 text-sm">
